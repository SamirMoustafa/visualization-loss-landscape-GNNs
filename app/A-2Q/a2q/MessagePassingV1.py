...
class MessagePassingMultiQuantV1(Module):
    def __init__(
        ...
        super(MessagePassingMultiQuantV1, self).__init__()
        ...
        if not quant_fea:
            ...
            self.q_xw = FeatureWeightQuantizationV1(1, out_features, bit, alpha_init=0.01, alpha_std=0.01)
...
class GINConvMultiQuantV1(MessagePassingMultiQuantV1):
    def __init__(
            self,
            nn,
            eps=0,
        ...
        super(GINConvMultiQuantV1, self).__init__(
            aggr="add",
