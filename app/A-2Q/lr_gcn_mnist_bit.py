...
from a2q.modules import FeatureWeightQuantizationV2, LinearQuantizationV2
...
class MyGCNConv(MessagePassing):
    def __init__(
        ...
        self.q_xw = FeatureWeightQuantizationV2(in_channels, out_channels, bit, alpha_init=0.05, alpha_std=0.02)
...
class GCN(torch.nn.Module):
    def __init__(
        ...
        if is_q:
            ...
            self.embedding = nn.Linear(dataset[0].x.size()[1] + dataset[0].pos.size()[1], hidden_units, bias=True)
